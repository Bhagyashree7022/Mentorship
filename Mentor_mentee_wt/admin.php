...
<body>
  <div style="display: flex; justify-content: space-between; align-items: center; padding: 5px 20px; background-color: #5982aa74; border-bottom: 1px solid #ccc;">
    <h2 style="margin: 0;">Dashboard</h2>
    <a href="logout.php" style="background-color: #d635dcff; color: white; padding: 8px 16px; border-radius: 5px; text-decoration: none;">Logout</a>
</div>
  ...
  <div class="container">
    ...
    <div class="grid-container">
      ...
      <a href="view_feedback.php" class="card card4">
        ...
        <a href="add_project.html" class="card card3">
        <h2>Add projects</h2>
        <p>Add new projects  projects.</p>

         <a href="view_project_ad.php" class="card card4">
